    ...
    <footer className="bg-black text-gray-300 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Why Siva?</h3>
            <p className="text-sm leading-relaxed">
              Established in 2000, Siva has since positioned itself as one
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">
              Domestic Flights with Siva
            </h3>
            <p className="text-sm leading-relaxed">
              Siva is India's leading player for flight bookings. With the
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm">
              © 2024 Siva PVT. LTD. All rights reserved
            </p>
          </div>
        </div>
      </div>
